...
describe Page do
  ...
  describe '#external' do
    context 'when the parent page has a different host' do
      subject { described_class.new 'example.com', parent: described_class.new('localhost:3000') }
    ...
    context 'when the parent page has the same host' do
      subject { described_class.new 'example.com/page', parent: described_class.new('example.com') }
  ...
  describe '#pages' do
    it 'returns an array of linked pages' do
      ...
      expect(subject.pages.first).to be_a described_class
    end
